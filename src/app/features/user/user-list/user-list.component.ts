...
export class UserListComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        EventEmitterService.get('UserFilterComponent.search').subscribe(
            (selected) => {
        ...
        this.userService
            ...
            .subscribe((data) => {
                ...
                if (data.statusMessage) {
                    UtilService.notifying.showError(
                        data.statusMessage,
                        `${data.statusCode}`
                    );
                    return;
    ...
    openUserViewModal(user: IUser) {
        ...
        this.bsModalRef = this.bsModalService.show(UserViewModalComponent, {
            id: 1,
            class: 'modal-lg',
            initialState,
        });
    ...
    openUserProfileEditModal(user: IUser) {
        ...
        this.bsModalRef = this.bsModalService.show(
            ...
            { id: 1, class: 'modal-lg', initialState }
        );
        // this.bsModalRef.content.closeBtnName = 'Close';
    }
    ...
    openUserFormModal(user: IUser) {
        const initialState = { user };
        this.bsModalRef = this.bsModalService.show(UserFormComponent, {
            id: 1,
            class: 'modal-lg',
            initialState,
        });
    ...
    openModal2(template: TemplateRef<any>) {
        this.bsModalRef2 = this.bsModalService.show(template, {
            id: 2,
            class: 'second',
        });
    }
